...
rem setting classpath for barcode4j
set LOCALCLASSPATH=%LOCALCLASSPATH%;%LIBDIR%\barcode4j.jar
set LOCALCLASSPATH=%LOCALCLASSPATH%;%LIBDIR%\barcode4j-fop-ext.jar

rem set LOCALCLASSPATH=%LOCALCLASSPATH%;%LIBDIR%\barcode4j-fop-ext-complete.jar
