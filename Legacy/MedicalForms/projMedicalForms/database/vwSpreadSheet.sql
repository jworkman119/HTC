...
where form.name in('Annual Health Screen Update' 
					, 'Appointment (Referral)'
					,'Appointment - 1st Letter Notification'
					, 'Appointment Letter'
					...
					, 'Prescriber Order Sheet'
					, 'Progress Note'
					, 'Proof Of Income'
					, 'Psychological Evaluation Form - Outside Agencies'
					, 'Psychosocial Assessment'
					, 'Record Request - Cannot be processed'
					, 'Record Request Letter'
					, 'Record Transfer'
					, 'Referral Form - Assisted Outpatient Treatment'
					, 'Referral Form: Case Management and Residential Services'
					, 'Referral Form: Case Management and Residential Services - Risk Assessment'
					, 'Risk Assessment'
					, 'Section 8 & LIDH - Application for Admission'
					, 'Threshold Override Application (TOA)'
					, 'Treatment Plan (outpatient)'
					, 'Treatment Plan Review (outpatient)'
					, 'VESID'
					, 'Work Capacity Determination'
)
group by question.question, Form.ID
